@extends('layouts.app', [
    ...
    'titlePage' => __('Nova Conta Bancária')
])
                ...
                <form method="POST" action="{{ route('contas-bancarias.store') }}">
                    ...
                    <div class="card">
                        <div class="card-header card-header-primary">
                            <h4 class="card-title">Nova Conta Bancária</h4>
                            <p class="card-category">Informe os dados da conta</p>
                        </div>
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="agencia" id="agencia" class="form-control" value="{{ old('agencia') }}">
                                @error('agencia')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="conta" id="conta" class="form-control" value="{{ old('conta') }}">
                                @error('conta')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="tipo_conta" id="tipo_conta" class="form-control" value="{{ old('tipo_conta') }}" placeholder="Corrente, Poupança, etc.">
                                @error('tipo_conta')
                                    <span class="text-danger">{{ $message }}</span>
                                @enderror
                            </div>
