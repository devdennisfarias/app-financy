...
@section('content')
    <div class="content">
        <div class="container-fluid">
            ...
            <x-page-header title="Editar Convênio">
            ...
            <x-card title="Dados do Convênio">
                <form method="POST" action="{{ route('convenios.update', $convenio->id) }}">
                    @csrf
                    @method('PUT')
                        ...
                        <div class="col-md-6">
                            <div class="input-group input-group-static mb-3">
                                ...
                                <input type="text" name="nome" id="nome" class="form-control"
                                    value="{{ old('nome', $convenio->nome) }}" required>
                            </div>
                        </div>
                            ...
                            <div class="form-check mt-4">
                                <label class="form-check-label">
                                    <input class="form-check-input" type="checkbox" name="ativo" value="1"
                                        {{ old('ativo', $convenio->ativo) ? 'checked' : '' }}>
                                    Ativo
