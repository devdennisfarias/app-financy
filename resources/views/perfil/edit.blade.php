...
@section('content')
    <div class="content">
        <div class="container-fluid">
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('perfil.update') }}" autocomplete="off" class="form-horizontal">
                        @csrf
                        @method('put')
            ...
            <div class="row">
                <div class="col-md-12">
                    <form method="post" action="{{ route('perfil.password') }}" class="form-horizontal">
                        @csrf
                        @method('put')
                        ...
                        <div class="card ">
                            ...
                            <div class="card-footer ml-auto mr-auto">
                                <button type="submit" class="btn btn-success">{{ __('Trocar senha') }}</button>
                            </div>
                        </div>
                    </form>
                </div>
