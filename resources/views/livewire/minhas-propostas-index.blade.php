            ...
            <div class="row d-flex justify-content-between">
                <div class="col-md-2">
                    @can('propostas.create')
                        <a href="{{ route('propostas.create') }}" class="btn btn-sm btn btn-success"><i
                    ...
                    <label class="w-100">
                        <span class="bmd-form-group">
                            <input type="text" class="form-control"
                                   placeholder="Procurar proposta" aria-controls="datatables" wire:model="search">                        
                        </span>
                    </label>
                </div>
            </div>
                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        @foreach ($propostas as $proposta)
                                            <tr>
                                                <td> {{ $proposta->id }} </td>
                                                <td> {{ number_format($proposta->porcentagem_comissao_vendedor, 1, ',', '.') . ' %' }} </td>
                                                ...
                                                <td> {{ number_format($proposta->tx_juros, 1, ',', '.') . ' %' }} </td>
