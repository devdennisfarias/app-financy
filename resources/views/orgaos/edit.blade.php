@extends('layouts.app', [
    'activePage' => 'orgaos',
    'titlePage' => __('Editar Órgão Pagador'),
])
...
@section('content')
    <div class="content">
        <div class="container-fluid">
            ...
            <x-page-header title="Editar Órgão Pagador">
            ...
            <x-card title="Dados do Órgão Pagador">
                <form method="POST" action="{{ route('orgaos.update', $orgao->id) }}">
                    @csrf
                    @method('PUT')
                                ...
                                <select name="convenio_id" id="convenio_id" class="form-control" required>
                                    ...
                                    @foreach ($convenios as $conv)
                                        <option value="{{ $conv->id }}"
                                            {{ old('convenio_id', $orgao->convenio_id) == $conv->id ? 'selected' : '' }}>
                                            {{ $conv->nome }}
                                        </option>
                                    @endforeach
                                </select>
