    ...
    <div class="sidebar-wrapper">
        <ul class="nav">
            ...
            @php
                ...
                $producaoOpen = in_array($activePage ?? '', ['producao-geral', 'producao-usuario']);

                $adminOpen = in_array($activePage ?? '', ['roles', 'status']);
            @endphp
                        ...
                        @can('convenios.index')
                            <li class="nav-item{{ ($activePage ?? '') == 'convenios' ? ' active' : '' }}">
                                <a class="nav-link" href="{{ route('convenios.index') }}">
                                    ...
                                    <span class="sidebar-normal">{{ __('Convênios') }}</span>
                                </a>
                            </li>
                        @endcan

                        @can('orgaos.index')
                            <li class="nav-item{{ ($activePage ?? '') == 'orgaos' ? ' active' : '' }}">
                                <a class="nav-link" href="{{ route('orgaos.index') }}">
                                    <i class="material-icons">apartment</i>
                                    <span class="sidebar-normal">{{ __('Órgãos Pagadores') }}</span>
                                </a>
                            </li>
                        @endcan
